...
enum AkAudioSessionCategory
{
	...
	AkAudioSessionCategory_Last,	///< End of enum, invalid value.
};
...
enum AkAudioSessionCategoryOptions
{
	...
	AkAudioSessionCategoryOptions_Last,				///< End of enum, invalid value.
};
...
enum AkAudioSessionMode
{
	...
	AkAudioSessionMode_Last,	///< End of enum, invalid value.
};
...
enum AkAudioSessionRouteSharingPolicy
{
	AkAudioSessionRouteSharingPolicyDefault = 0, ///< Corresponds to AVAudioSessionRouteSharingPolicyDefault
	AkAudioSessionRouteSharingPolicyLongFormAudio = 1, ///< Corresponds to AVAudioSessionRouteSharingPolicyLongFormAudio
	AkAudioSessionRouteSharingPolicyLongFormVideo = 3, ///< Corresponds to AVAudioSessionRouteSharingPolicyLongFormVideo
	AkAudioSessionRouteSharingPolicy_Last,		///< End of enum, invalid value.
};
...
/// - \ref AkAudioSessionRouteSharingPolicy
struct AkAudioSessionProperties
{
	...
	AkAudioSessionRouteSharingPolicy eRouteSharingPolicy; ///< \sa AkAudioSessionRouteSharingPolicy
...
namespace AK
{
	namespace SoundEngine
	{
		namespace iOS
		{
			...
			/// input sample data to the sound engine and perform brief custom processing. The input data sample rate must be the same as the app's AVAudioSession.
